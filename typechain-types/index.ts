...
export type { MappingExample } from "./contracts/MyMap.sol/MappingExample";
export { MappingExample__factory } from "./factories/contracts/MyMap.sol/MappingExample__factory";
